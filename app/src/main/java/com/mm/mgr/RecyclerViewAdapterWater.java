...
public class RecyclerViewAdapterWater extends RecyclerView.Adapter<RecyclerViewAdapterWater.ViewHolder> {
    ...
    RecyclerViewAdapterWater(Context context, List<Plant> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_water_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intentCreatePlant = new Intent(itemView.getContext(), PlantSingleViewActivity.class);
